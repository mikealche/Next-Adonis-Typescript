...
var RouteObject = /** @class */ (function () {
    ...
    RouteObject.prototype.request = function () {
        var args = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.method === "get") {
                    ...
                    return [2 /*return*/, api[this.method].apply(api, __spreadArrays([this.route], args))];
                }
                return [2 /*return*/, Promise.reject("invalid method")];
            });
        });
    };
    return RouteObject;
}());
var me = new RouteObject("get", "/auth/me", "AuthController.me");
var userRoutes = {
    me: new RouteObject("get", "/auth/me", "AuthController.me"),
    signup: new RouteObject("post", "/auth/signup", "AuthController.signup"),
    login: new RouteObject("post", "/auth/login", "AuthController.login"),
};
